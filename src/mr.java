...
public final class mr extends Provider implements mv {
   private static String byte = "BouncyCastle Security Provider v1.47";
   public static String if = "BC";
   public static final mu a = new mp();
   private static final Map try = new HashMap();
   private static final String[] new = new String[]{"AES", "ARC4", "Blowfish", "Camellia", "CAST5", "CAST6", "DES", "DESede", "GOST28147", "Grainv1", "Grain128", "HC128", "HC256", "IDEA", "Noekeon", "RC2", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Skipjack", "TEA", "Twofish", "VMPC", "VMPCKSA3", "XTEA"};
   private static final String[] int = new String[]{"X509"};
   private static final String[] for = new String[]{"DSA", "DH", "EC", "RSA", "GOST", "ECGOST", "ElGamal"};
   private static final String[] do = new String[]{"GOST3411", "MD2", "MD4", "MD5", "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "Tiger", "Whirlpool"};

   public mr() {
      super(if, 1.47D, byte);
      AccessController.doPrivileged(new mq(this));
   }

   private void if() {
      this.a("org.bouncycastle.jcajce.provider.digest.", do);
      this.a("org.bouncycastle.jcajce.provider.symmetric.", new);
      this.a("org.bouncycastle.jcajce.provider.asymmetric.", int);
      this.a("org.bouncycastle.jcajce.provider.asymmetric.", for);
      ...
      this.put("AlgorithmParameters." + na.a, "org.bouncycastle.jce.provider.JDKAlgorithmParameters$PBKDF2");
      ...
      this.put("Alg.Alias.AlgorithmParameters." + nb.new.if(), "PKCS12PBE");
      this.put("Alg.Alias.AlgorithmParameters." + nb.int.if(), "PKCS12PBE");
      this.put("Alg.Alias.AlgorithmParameters." + nb.for.if(), "PKCS12PBE");
      this.put("Alg.Alias.AlgorithmParameters." + nb.do.if(), "PKCS12PBE");
      this.put("Alg.Alias.AlgorithmParameters." + nb.if.if(), "PKCS12PBE");
      this.put("Alg.Alias.AlgorithmParameters." + nb.a.if(), "PKCS12PBE");
      ...
      this.put("Alg.Alias.Cipher." + nb.new.if(), "PBEWITHSHAAND128BITAES-CBC-BC");
      this.put("Alg.Alias.Cipher." + nb.int.if(), "PBEWITHSHAAND192BITAES-CBC-BC");
      this.put("Alg.Alias.Cipher." + nb.for.if(), "PBEWITHSHAAND256BITAES-CBC-BC");
      this.put("Alg.Alias.Cipher." + nb.do.if(), "PBEWITHSHA256AND128BITAES-CBC-BC");
      this.put("Alg.Alias.Cipher." + nb.if.if(), "PBEWITHSHA256AND192BITAES-CBC-BC");
      this.put("Alg.Alias.Cipher." + nb.a.if(), "PBEWITHSHA256AND256BITAES-CBC-BC");
      ...
      this.put("Alg.Alias.Cipher." + na.byte, "PBEWITHMD2ANDDES");
      this.put("Alg.Alias.Cipher." + na.try, "PBEWITHMD2ANDRC2");
      this.put("Alg.Alias.Cipher." + na.new, "PBEWITHMD5ANDDES");
      this.put("Alg.Alias.Cipher." + na.int, "PBEWITHMD5ANDDES");
      this.put("Alg.Alias.Cipher." + na.for, "PBEWITHSHA1ANDDES");
      this.put("Alg.Alias.Cipher." + na.do, "PBEWITHSHA1ANDRC2");
      ...
      this.put("Alg.Alias.SecretKeyFactory." + na.byte, "PBEWITHMD2ANDDES");
      this.put("Alg.Alias.SecretKeyFactory." + na.try, "PBEWITHMD2ANDRC2");
      this.put("Alg.Alias.SecretKeyFactory." + na.new, "PBEWITHMD5ANDDES");
      this.put("Alg.Alias.SecretKeyFactory." + na.int, "PBEWITHMD5ANDDES");
      this.put("Alg.Alias.SecretKeyFactory." + na.for, "PBEWITHSHA1ANDDES");
      this.put("Alg.Alias.SecretKeyFactory." + na.do, "PBEWITHSHA1ANDRC2");
      ...
      this.put("Alg.Alias.SecretKeyFactory." + na.try, "PBEWITHMD2ANDRC2");
      this.put("Alg.Alias.SecretKeyFactory." + na.new, "PBEWITHMD5ANDDES");
      this.put("Alg.Alias.SecretKeyFactory." + na.int, "PBEWITHMD5ANDRC2");
      this.put("Alg.Alias.SecretKeyFactory." + na.for, "PBEWITHSHA1ANDDES");
      this.put("Alg.Alias.SecretKeyFactory." + na.do, "PBEWITHSHA1ANDRC2");
      ...
      this.put("Alg.Alias.SecretKeyFactory." + nb.new.if(), "PBEWITHSHAAND128BITAES-CBC-BC");
      this.put("Alg.Alias.SecretKeyFactory." + nb.int.if(), "PBEWITHSHAAND192BITAES-CBC-BC");
      this.put("Alg.Alias.SecretKeyFactory." + nb.for.if(), "PBEWITHSHAAND256BITAES-CBC-BC");
      this.put("Alg.Alias.SecretKeyFactory." + nb.do.if(), "PBEWITHSHA256AND128BITAES-CBC-BC");
      this.put("Alg.Alias.SecretKeyFactory." + nb.if.if(), "PBEWITHSHA256AND192BITAES-CBC-BC");
      this.put("Alg.Alias.SecretKeyFactory." + nb.a.if(), "PBEWITHSHA256AND256BITAES-CBC-BC");
      this.a();
