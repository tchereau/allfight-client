...
public class k6 extends Panel {
   public k6(aqh var1) {
      this.setBackground(new Color(3028036));
      this.setLayout(new BorderLayout());
      StringWriter var2 = new StringWriter();
      var1.if().printStackTrace(new PrintWriter(var2));
      ...
      if (var3.contains("Pixel format not accelerated")) {
         ...
         var6 = var6 + "      ----------------------      \n";
         var6 = var6 + "\n";
         var6 = var6 + "Minecraft has stopped running because it encountered a problem; " + var1.case() + "\n\n";
         File var7 = var1.try();
         if (var7 == null) {
            var1.a(new File(new File(Minecraft.hQ(), "crash-reports"), "crash-" + (new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date()) + "-client.txt"), Minecraft.ih().a());
            var7 = var1.try();
         }
      ...
      this.add(new k4(), "North");
      this.add(new k5(80), "East");
      this.add(new k5(80), "West");
      this.add(new k5(100), "South");
