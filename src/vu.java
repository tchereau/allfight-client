...
public class vu extends vp {
   public vu(int var1, Random var2, wc var3, int var4) {
      super(var1);
      this.if = var4;
      this.do = var3;
   }
   ...
   public static vu d(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      wc var7 = wc.a(var2, var3, var4, -1, 0, 0, 5, 7, 5, var5);
      return if(var7) && uk.a(var0, var7) == null ? new vu(var6, var1, var7, var5) : null;
   }
   ...
   public boolean a(y6 var1, Random var2, wc var3) {
      ...
      this.a(var1, var3, 0, 2, 4, 3, 5, 4, pa.bY.void, pa.bY.void, false);
