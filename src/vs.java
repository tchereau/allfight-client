...
public class vs extends vp {
   public vs(int var1, Random var2, wc var3, int var4) {
      super(var1);
      this.if = var4;
      this.do = var3;
   }
   ...
   public static vs b(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      wc var7 = wc.a(var2, var3, var4, -1, 0, 0, 5, 7, 5, var5);
      return if(var7) && uk.a(var0, var7) == null ? new vs(var6, var1, var7, var5) : null;
   }
   ...
   public boolean a(y6 var1, Random var2, wc var3) {
      ...
      this.a(var1, var3, 1, 2, 4, 4, 5, 4, pa.bY.void, pa.bY.void, false);
      this.a(var1, var3, 1, 3, 4, 1, 4, 4, pa.bW.void, pa.bY.void, false);
      this.a(var1, var3, 3, 3, 4, 3, 4, 4, pa.bW.void, pa.bY.void, false);
