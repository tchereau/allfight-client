public class l extends abr {
   public static final String[] cC = new String[]{"SaphirBow_pull_0", "SaphirBow_pull_1", "SaphirBow_pull_2"};
   private ajd[] cB;
   ...
   public void a(ajc var1) {
      super.a(var1);
      this.cB = new ajd[cC.length];

      for(int var2 = 0; var2 < this.cB.length; ++var2) {
         this.cB[var2] = var1.a(cC[var2]);
      }

   }

   public ajd int(int var1) {
      return this.cB[var1];
   }
}
