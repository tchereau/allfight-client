public class pz extends r8 {
   private ajd ee;

   protected pz(int var1) {
      super(var1, ts.w);
      this.a(acn.c);
   }

   public ajd if(int var1, int var2) {
      return var1 == 1 ? this.ee : this.an;
   }
   ...
   public void if(y6 var1, int var2, int var3, int var4, abp var5) {
      if (!var1.goto) {
   ...
   public void E(y6 var1, int var2, int var3, int var4) {
      if (!var1.goto) {
         py var5 = (py)var1.if(var2, var3, var4);
         if (var5 != null) {
            abp var6 = var5.gD();
            if (var6 != null) {
               var1.for(1005, var2, var3, var4, 0);
               var1.if((String)null, var2, var3, var4);
               var5.d((abp)null);
   ...
   public void a(ajc var1) {
      this.an = var1.a("musicBlock");
      this.ee = var1.a("jukebox_top");
   }
