public class ac8 extends abr {
   public static final String[] dY = new String[]{"RubisBow_pull_0", "RubisBow_pull_1", "RubisBow_pull_2"};
   private ajd[] dX;
   ...
   public void a(ajc var1) {
      super.a(var1);
      this.dX = new ajd[dY.length];

      for(int var2 = 0; var2 < this.dX.length; ++var2) {
         this.dX[var2] = var1.a(dY[var2]);
      }

   }

   public ajd goto(int var1) {
      return this.dX[var1];
   }
}
